...
class MyTopo(Topo):
    def __init__(self, sw_path, json_path, thrift_port1, thrift_port2, pcap_dump, **opts):
        ...
        self.addLink(server_1, switch_1)
        self.addLink(server_1, switch_2)

        # set server_2
        server_2 = self.addHost('server_2',
                                ip = '140.116.0.2',
                                mac = '00:10:00:00:00:01')
        self.addLink(server_2, switch_1)
        self.addLink(server_2, switch_2)
...
def main():
    ...
    sw_mac = ["00:02:00:00:00:01", "00:02:00:00:00:02", 
              ...
              "00:10:00:00:00:00", "00:10:00:00:00:01"]
