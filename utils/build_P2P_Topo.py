    ...
    def __init__(self, hosts, switches, links, log_dir, bmv2_exe, pcap_dir, **opts):
        ...
        for sw, params in switches.iteritems():
            ...
            if "program" in params:
                switchClass = configureP4Switch(sw_path=bmv2_exe,
...
class ExerciseRunner:
    ...
    def program_switches(self):
        ...
        """
        print '[ program_switches ] switches = ', self.switches 
    ...
    def program_hosts(self):
        ...
        for host_name, host_info in self.hosts.items():
            print '[ program_hosts ] host_name = ', host_name
            print '[ program_hosts ] host_info = ', host_info, '\n'
            h = self.net.get(host_name)
            if "commands" in host_info:
                for cmd in host_info["commands"]:
                    # set default gateway and ARP mapping
                    h.cmd(cmd)
